...
1. git clone git@github.com:Santosh-Konappanavar/bookstoreUsing-react.git
2. cd bookstoreUsing-react
...
This project is [MIT](https://github.com/Santosh-Konappanavar/bookstoreUsing-react/blob/development/LICENSE) licensed.
